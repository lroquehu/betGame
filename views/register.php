                ...
                <div class="card bg-black border-secondary shadow-lg position-relative text-white">
                    ...
                    <div class="card-body p-5">
                        <div class="text-center mb-4">
                            <h2 class="text-warning fw-bold mb-1">REGISTRO</h2>
                            <span class="badge bg-warning text-dark">BONO $10.00 GRATIS</span>
                        </div>
                        ...
                        <form action="/register" method="POST">
                            ...
                            <button type="submit" class="btn btn-warning w-100 fw-bold py-2">CREAR CUENTA</button>
                        </form>
                        
                        <div class="text-center mt-4">
                            <a href="/login" class="text-warning text-decoration-none small">¿Ya tienes cuenta? Inicia sesión</a>
                        </div>
                    </div>
                </div>
            </div>
